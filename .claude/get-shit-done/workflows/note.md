...
- **Global scope**: `/Users/jeongmin/youtube-shorts-automation/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jeongmin/youtube-shorts-automation/.claude/notes/`)
...
2. Glob `/Users/jeongmin/youtube-shorts-automation/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jeongmin/youtube-shorts-automation/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jeongmin/youtube-shorts-automation/.claude/notes/` — works in any directory
